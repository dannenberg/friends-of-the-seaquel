...
SCREEN_SIZE, RS, US = (600, 450), chr(30), chr(31)
...
class Inputbox:
    def __init__(self):
        size = (CHAT_WIDTH, CHAT_FONT_HEIGHT + CHAT_EDGE)
        self.bg_surface = pygame.Surface(size, pygame.SRCALPHA)
        draw_rounded_rect(self.bg_surface, (0, 0, 0, 192), ((0, 0), size), 10)
...
class Chatbox:
    def __init__(self):
        ...
        self.bg_surface = pygame.Surface((CHAT_WIDTH, CHAT_HEIGHT), pygame.SRCALPHA)
        draw_rounded_rect(self.bg_surface, (0, 0, 0, 192), ((0, 0), (CHAT_WIDTH, CHAT_HEIGHT)), 10)
